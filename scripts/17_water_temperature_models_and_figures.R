# 17_water_temperature_models_and_figures.R
...
script_figure_dir <- fs::path(figures_dir, "17")
...
# ----------------------------------------------------------------------
# 6. Water temperature exploratory checks
# ----------------------------------------------------------------------
par(mar = c(5, 5, 4, 2), cex = 0.9)

make_pairs_plot(
  ~ eff + airtemp + dtemp + solar + canop + res300 + rain3 + dayflow + depth + temp,
  data = alldata
)

tempo <- lm(temp ~ eff, data = alldata)
print_model_block("temp_eff", tempo)

tempo <- lm(temp ~ airtemp, data = alldata)
print_model_block("temp_airtemp", tempo)

tempo <- lm(temp ~ dtemp, data = alldata)
print_model_block("temp_dtemp", tempo)

tempo <- lm(temp ~ canop, data = alldata)
print_model_block("temp_canop", tempo)

tempo <- lm(temp ~ solar, data = alldata)
print_model_block("temp_solar", tempo)

png(
  filename = fs::path(script_figure_dir, "17_temp_spatial_position.png"),
  width = 2400,
  height = 1800,
  res = 300
)
plot(alldata[alldata$day == 1, "dist"], alldata[alldata$day == 1, "temp"], type = "b", ylim = c(0, 30), pch = 19, xlab = "Distance(km)", ylab = "Temperature", main = "Temperature with spatiotemporal prediction", lwd = 3, lty = 1)
points(alldata[alldata$day == 126, "dist"], alldata[alldata$day == 126, "temp"], type = "b", col = "gold2", pch = 15, lwd = 3, cex = 1.2, lty = 2)
points(alldata[alldata$day == 260, "dist"], alldata[alldata$day == 260, "temp"], type = "b", col = "blue", pch = 8, cex = 1.2, lwd = 3, lty = 3)
points(alldata[alldata$day == 336, "dist"], alldata[alldata$day == 336, "temp"], type = "b", col = "green3", pch = 17, cex = 1.2, lwd = 3, lty = 4)
points(alldata[alldata$day == 518, "dist"], alldata[alldata$day == 518, "temp"], type = "b", col = "red", pch = 18, cex = 1.4, lwd = 3, lty = 5)
...
# ----------------------------------------------------------------------
# 7. Water temperature spatiotemporal model
# ----------------------------------------------------------------------
tempo <- lm(temp ~ dist + time + dist:time, data = alldata)

cat("\n============================================================\n")
cat("Water temperature spatiotemporal model\n")
cat("============================================================\n")
print(anova(tempo))
print(summary(tempo))

png(
  filename = fs::path(script_figure_dir, "17_temp_spatiotemporal_diagnostics.png"),
  width = 2400,
  height = 1800,
  res = 300
)
...
png(
  filename = fs::path(script_figure_dir, "17_temp_spatiotemporal_qqnorm.png"),
  width = 2400,
  height = 1800,
  res = 300
)
...
png(
  filename = fs::path(script_figure_dir, "17_temp_spatiotemporal_residual_hist.png"),
  width = 2400,
  height = 1800,
  res = 300
)
...
png(
  filename = fs::path(script_figure_dir, "17_temp_spatiotemporal_prediction.png"),
  width = 2400,
  height = 1800,
  res = 300
)
plot(tempo1[tempo1$time == 1, "dist"], tempo1[tempo1$time == 1, "temp"], type = "p", pch = 19, col = "black", xlab = "Distance (km)", ylab = "Temperature", main = "Temperature with spatiotemporal prediction", ylim = c(0, 30), cex = 1, lwd = 3, lty = 1)
points(tempo1[tempo1$time == 2, "dist"], tempo1[tempo1$time == 2, "temp"], col = "gold2", pch = 15, cex = 1.2, lwd = 3, lty = 2)
points(tempo1[tempo1$time == 3, "dist"], tempo1[tempo1$time == 3, "temp"], col = "blue", pch = 8, cex = 1.2, lwd = 3, lty = 3)
points(tempo1[tempo1$time == 4, "dist"], tempo1[tempo1$time == 4, "temp"], col = "green3", pch = 17, cex = 1.2, lwd = 3, lty = 4)
points(tempo1[tempo1$time == 5, "dist"], tempo1[tempo1$time == 5, "temp"], col = "red", pch = 18, cex = 1.4, lwd = 3, lty = 5)
...
png(
  filename = fs::path(script_figure_dir, "17_temp_environmental_diagnostics.png"),
  width = 2400,
  height = 1800,
  res = 300
)
...
cat("\n============================================================\n")
cat("Water temperature residual spatiotemporal check\n")
cat("============================================================\n")
print(summary(tempo.check))
print(anova(tempo.check))

png(
  filename = fs::path(script_figure_dir, "17_temp_environmental_avplots.png"),
  width = 2400,
  height = 1800,
  res = 300
)
...
png(
  filename = fs::path(script_figure_dir, "17_temp_environmental_prediction.png"),
  width = 2400,
  height = 1800,
  res = 300
)
plot(tempo1[tempo1$day == 1, "dist"], tempo1[tempo1$day == 1, "1"], type = "l", ylim = c(0, 30), pch = 19, col = "black", xlab = "Distance(km)", ylab = "Temperature", main = "Temperature with other variables", lwd = 3, lty = 1)
...
png(
  filename = fs::path(script_figure_dir, "17_temp_environmental_residuals_distance.png"),
  width = 2400,
  height = 1800,
  res = 300
)
plot(tempo1[tempo1$day == 1, "dist"], tempo1[tempo1$day == 1, "2"], type = "b", ylim = c(-2, 2), pch = 19, cex = 1.5, xlab = "Distance(km)", ylab = "residuals", main = "prediction with space and time", lwd = 3, lty = 4)
...
png(
  filename = fs::path(script_figure_dir, "17_temp_residual_time_space_diagnostics.png"),
  width = 2400,
  height = 1800,
  res = 300
)
...
# ----------------------------------------------------------------------
tiff(
  file = fs::path(script_figure_dir, "17_figure_12_water_temperature.tif"),
  width = 10,
  height = 14,
  units = "in",
  pointsize = 12,
...
plot(alldata[alldata$day == 1, "dist"], alldata[alldata$day == 1, "temp"], type = "b", ylim = c(0, 30), pch = 19, xlab = "Distance(km)", ylab = "Water temperature (-C)", main = "a) Water temperature with spatiotemporal prediction", lwd = 3, lty = 1)
points(alldata[alldata$day == 126, "dist"], alldata[alldata$day == 126, "temp"], type = "b", col = "gold2", pch = 15, lwd = 3, cex = 1.2, lty = 2)
points(alldata[alldata$day == 260, "dist"], alldata[alldata$day == 260, "temp"], type = "b", col = "blue", pch = 8, cex = 1.2, lwd = 3, lty = 3)
points(alldata[alldata$day == 336, "dist"], alldata[alldata$day == 336, "temp"], type = "b", col = "green3", pch = 17, cex = 1.2, lwd = 3, lty = 4)
points(alldata[alldata$day == 518, "dist"], alldata[alldata$day == 518, "temp"], type = "b", col = "red", pch = 18, cex = 1.4, lwd = 3, lty = 5)
...
plot(tempo1[tempo1$time == 1, "dist"], tempo1[tempo1$time == 1, "temp"], type = "p", pch = 19, col = "black", xlab = "Distance (km)", ylab = "Water temperature (-C)", main = "b) Water temperature with spatiotemporal prediction", ylim = c(0, 30), cex = 1, lwd = 3, lty = 1)
points(tempo1[tempo1$time == 2, "dist"], tempo1[tempo1$time == 2, "temp"], col = "gold2", pch = 15, cex = 1.2, lwd = 3, lty = 2)
points(tempo1[tempo1$time == 3, "dist"], tempo1[tempo1$time == 3, "temp"], col = "blue", pch = 8, cex = 1.2, lwd = 3, lty = 3)
points(tempo1[tempo1$time == 4, "dist"], tempo1[tempo1$time == 4, "temp"], col = "green3", pch = 17, cex = 1.2, lwd = 3, lty = 4)
points(tempo1[tempo1$time == 5, "dist"], tempo1[tempo1$time == 5, "temp"], col = "red", pch = 18, cex = 1.4, lwd = 3, lty = 5)
...
plot(tempo1[tempo1$day == 1, "dist"], tempo1[tempo1$day == 1, "1"], type = "b", ylim = c(0, 30), pch = 19, col = "black", xlab = "Distance(km)", ylab = "Water temperature (-C)", main = "c) Water temperature with other variables", lwd = 3, lty = 1)
